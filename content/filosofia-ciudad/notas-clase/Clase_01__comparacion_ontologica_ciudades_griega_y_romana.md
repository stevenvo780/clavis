...
- la ciudad tiene un `telos`;
- ese fin es el florecimiento humano;
...
- `urbs` nombra la ciudad material, física, construida;
- `civitas` nombra la comunidad cívica y jurídica.
...
- replica la `urbs` en colonias;
- exporta instituciones;
- extiende la `civitas` a territorios distantes;
- articula espacio urbano e Imperio.
...
- [Comparación morfológica entre Grecia y Roma](./comparacion_morfologica_ciudades_griega_y_romana.md), porque desarrolla el trazado, los equipamientos y la implantación territorial;
- [Urbs, civitas, urbanitas, cité y ville](./urbs_civitas_urbanitas_glosario_romano.md), porque precisa la relación entre soporte material y comunidad política;
- [Aristóteles: arquitectura, *telos* y eudaimonía](./aristoteles_arquitectura_telos.md), porque la ontología teleológica griega remite al `telos` y a la `eudaimonía`;
- [Hipódamo de Mileto y la planeación clásica](./hipodamo_de_mileto_planeacion_clasica.md), porque la racionalidad urbana griega todavía opera dentro del horizonte de la `polis`, no de una lógica imperial expansiva.
