...
La vía griega tiende a ser **cívica y local**.
La vía romana tiende a ser **urbana, imperial y logística**.
...
- [Comparación morfológica entre Grecia y Roma](./comparacion_morfologica_ciudades_griega_y_romana.md), por la comparación general entre trazado orgánico y retícula romana;
- [Hipódamo de Mileto y la planeación clásica](./hipodamo_de_mileto_planeacion_clasica.md), por la jerarquía de ejes y la planificación griega;
- [La ciudad como orden político y económico](./orden_politico_y_orden_economico_de_la_ciudad.md), porque las vías articulan tanto lo común como los intercambios;
- [Comparación ontológica entre Grecia y Roma](./comparacion_ontologica_ciudades_griega_y_romana.md), porque la diferencia vial expresa también dos modos distintos de pensar la ciudad.
