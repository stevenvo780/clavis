...
En el horizonte clásico, especialmente en Platón y Aristóteles, la ciudad
tiende a pensarse como una realidad orientada a un bien. Su finalidad no se
agota en resolver circulación, defensa o abastecimiento: debe hacer posible una
forma de vida ética y política.

La fórmula **fin ético, no medio técnico** no niega la materialidad urbana.
Indica que murallas, calles, edificios e instituciones se juzgan por el tipo de
vida común que permiten realizar. Desde esta perspectiva:

- Platón vincula el orden de la ciudad con un modelo normativo de justicia;
- Aristóteles entiende la `polis` como culminación de la asociación humana y
  condición de la vida buena;
- la técnica urbana queda subordinada a fines políticos y éticos.

Este marco permite establecer un contraste histórico sin convertirlo en una
oposición absoluta:

- en Grecia clásica predomina la lectura teleológica de la comunidad;
- en Roma ganan peso la articulación jurídica, la administración y la
  expansión territorial;
- en la modernidad se intensifica la lectura técnica, económica y funcional de
  la ciudad.
...
- [La ciudad antigua: Platón y Aristóteles](./la_ciudad_antigua_platon_y_aristoteles_origen_y_fin_de_lo_urbano.md), por las dos formulaciones clásicas del origen y el fin urbano;
- [Aristóteles: arquitectura, *telos* y eudaimonía](./aristoteles_arquitectura_telos.md), por la prioridad de la causa final;
- [La ciudad como orden político y económico](./orden_politico_y_orden_economico_de_la_ciudad.md), porque el orden urbano expresa finalidades distintas;
- [Ciudad amurallada: membrana y permeabilidad](./ciudad_amurallada_membrana_y_permeabilidad.md), porque una ciudad orientada a la seguridad ordena de cierto modo su borde;
- [Ciudades romanas e Imperio](./ciudades_romanas_imperio_y_expansion_urbana.md), porque una ciudad imperial responde a fines distintos de una `polis` orientada a la vida buena.
