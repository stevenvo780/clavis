...
export const MODULE_META = {
  griego: {
    ...
    description: 'Lecciones, glosario, ejercicios, gramáticas de referencia y traducciones del curso de griego clásico. Análisis morfológico y textos comentados.',
    ...
    color: 'amber',
    icon: 'Alpha',
    sections: ['Clases', 'Glosario', 'Traducciones', 'Ejercicios', 'Gramáticas', 'Recursos'],
  },
  neurofilosofia: {
    label: 'Neurofilosofía',
    labelEn: 'Neurophilosophy',
    description: 'Base de conocimiento del curso Filosofía de las Neurociencias. 210 documentos: clases, notas de clase, autores, temas transversales, lecturas, lógica formal y ensayos.',
    ...
    color: 'violet',
    icon: 'Brain',
    sections: ['Clases', 'Notas de clase', 'Autores', 'Temas', 'Lecturas', 'Referencia', 'Ensayos', 'Lógica Formal'],
  },
  'filosofia-ciudad': {
    label: 'Filosofía de la Ciudad',
    labelEn: 'Philosophy of the City',
    description: 'Archivo académico del curso Filosofía de la ciudad: ontología, poder y política. Clases, notas de clase, lecturas base (Heidegger, Sassen, Yuk Hui, Calvino) y trabajos.',
